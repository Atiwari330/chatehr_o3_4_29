...
- Only files matching these patterns are included: package.json, README.md, app/layout.tsx, app/(chat)/page.tsx, app/(chat)/chat/[id]/page.tsx, app/(auth)/auth.ts, middleware.ts, lib/db/schema.ts, lib/db/queries.ts, lib/ai/models.ts, lib/ai/prompts.ts, app/(chat)/api/chat/route.ts, components/chat.tsx, components/message.tsx, components/sidebar-history.tsx, lib/ai/tools/create-document.ts, lib/ai/tools/update-document.ts, lib/ai/tools/get-weather.ts
